...
//#define SAMPLING_TIME	75*CLOCK_SECOND
...
PERIODIC_RESOURCE(resource_humidity, "title=\"humidity\";rt=\"Text\";obs", get_handler, NULL, NULL, NULL, 1500*CLOCK_SECOND, periodic_handler);
